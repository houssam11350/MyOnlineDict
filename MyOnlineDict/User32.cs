...
namespace MyOnlineDict.Win32
{
    ...
    public class User32
    {
        ...
        static FLASHWINFO fInfo = new FLASHWINFO();
        public static bool MyFlashWindowEx(IntPtr hWnd)
        {
            fInfo.cbSize = Convert.ToUInt32(Marshal.SizeOf(fInfo));
            fInfo.hwnd = hWnd;
            fInfo.dwFlags = (uint)FlashWindow.FLASHW_ALL;
            fInfo.uCount = (uint)1; //UInt32.MaxValue;
            fInfo.dwTimeout = 0;
    ...
    public enum Msgs
    {
        ...
        WM_APP = 0x8000,
        WM_USER = 0x0400,
       WM_CLIPBOARDUPDATE = 0x031D , // by houssam
       WM_MY_MSG_1 = 0x2a2 ,
       WM_MY_MSG_MOUSE_BUTTON_4_5 = 0x319 ,
